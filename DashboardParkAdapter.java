...
public class DashboardParkAdapter extends RecyclerView.Adapter<DashboardParkAdapter.ParkViewHolder> {

    private List<ParkItem> parkItemList;

    public DashboardParkAdapter(List<ParkItem> parkItemList) {
        this.parkItemList = parkItemList;
    }

    @NonNull
    @Override
    public DashboardParkAdapter.ParkViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.park_item, parent, false);
        return new DashboardParkAdapter.ParkViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DashboardParkAdapter.ParkViewHolder holder, int position) {
